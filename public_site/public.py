...
from landing import AboutPage, TeamPage, HomePage, ProfessionalDevelopmentPage, HomePageExample, VideosPage, LessonsPage, AssessmentsPage
...
APP = webapp2.WSGIApplication([
                               ...
                               webapp2.Route('/videos/', handler=VideosPage, name='home'),
